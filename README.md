...
**Wardrobe Stylist** is a smart, local web-based agentic application that helps users decide what to wear — powered by GPT-4o, computer vision, and Model Context Protocol (MCP).
